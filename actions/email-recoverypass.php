                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td valign="top" width="48%" align="center">
                                                <span>
                                                    <a href="https://www.danielemanzi.it/6-note/?page=newpass&email=$email&hash=$hash"
                                                    style="display:block;padding:15px 25px;background-color:#0087d1;color:#ffffff;border-radius:3px;text-decoration:none" target="_blank">Reimposta la password</a>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr><td height="20"></td></tr>
